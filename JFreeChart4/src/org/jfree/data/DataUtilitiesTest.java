...
//			Calculating column total for the last column
		...
		@Test
	    public void testCalculateRowTotal_ZeroColumnCount() {
	        // Given
	        final int row = 0;
	        final int columnCount = 0;
	        final double expectedTotal = 0.0;
	        ...
	        // Then
	        assertEquals(expectedTotal, result, 0.000001);
	    }

	    @Test
	    public void testCalculateRowTotal_PositiveColumnCount() {
	        // Given
	        final int row = 0;
	        final int columnCount = 3;
	        final double[][] testData = {{1.0, 2.0, 3.0}};
	        final double expectedTotal = 6.0;
	        ...
	        mockingContext.checking(new Expectations() {
	            {
	                ...
	                for (int c = 0; c < columnCount; c++) {
	                    oneOf(values).getValue(row, c);
	                    will(returnValue(testData[0][c]));
	                }
	            }
	        });
	    ...
	    public void testCalculateRowTotal_NegativeColumnCount() {
	        ...
	        final int row = 0;
	        final int columnCount = -3;
	        final double expectedTotal = 0.0; // Negative column count should result in total = 0
	        ...
	        mockingContext.checking(new Expectations() {
	            {
	                oneOf(values).getColumnCount();
	                will(returnValue(columnCount));
	                // No expectations for getValue since the loop won't execute
	            }
	        });
	    ...
	    @Test
	    public void testCalculateRowTotal_LargeNegativeColumnCount() {
	        // Given
	        final int row = 0;
	        final int columnCount = Integer.MIN_VALUE; // Large negative value
	        final double expectedTotal = 0.0; // No actual data, so total should be 0
	    ...
	    @Test
	    public void testEqual_ArraysOfDifferentLengths() {
	        double[][] a = {{1.0, 2.0}, {3.0, 4.0}};
	    ...
	    @Test
	    public void testEqual_ArraysWithDifferentValues() {
	        double[][] a = {{1.0, 2.0}, {3.0, 4.0}};
	    ...
	    @Test
	    public void testEqual_SameArrays() {
	        double[][] a = {{1.0, 2.0}, {3.0, 4.0}};
	        double[][] b = {{1.0, 2.0}, {3.0, 4.0}};
	        assertTrue(DataUtilities.equal(a, b));
	    }
	    ...
	    @Test
	    public void testEqual_DifferentObjectsSameContents() {
	        double[][] a = {{1.0, 2.0}, {3.0, 4.0}};
	    ...
	    public void testCalculateColumnTotal_EmptyValidRows() {
	        ...
	        final int column = 0;
	        final int[] validRows = {};
	        final double expectedTotal = 0.0; // Since validRows is empty, no calculation should be made

	        // Expectations
	        mockingContext.checking(new Expectations() {
	            {
	                oneOf(values).getRowCount();
	                will(returnValue(3)); // Set arbitrary row count
	                // No expectations for getValue since the loop won't execute
	            }
	        });
	    ...
	    @Test
	    public void testCalculateColumnTotal_ValidRowsWithinBounds() {
	        // Given
	        final int column = 0;
	        final int[] validRows = {0, 1}; // Valid rows within bounds
	        final double[][] testData = {{1.0}, {2.0}, {3.0}};
	        final double expectedTotal = 3.0; // Total of first two rows' values

	        // Expectations
	        mockingContext.checking(new Expectations() {
	            {
	                oneOf(values).getRowCount();
	                will(returnValue(testData.length));
	                for (int row : validRows) {
	                    oneOf(values).getValue(row, column);
	                    will(returnValue(testData[row][column]));
	                }
	            }
	        });
	    ...
	    public void testCalculateRowTotal_ZeroColumns() {
	        // Given
	        final int row = 0;
	        final Values2D emptyData = new DefaultKeyedValues2D(); // Empty data with zero columns
	        final double expectedTotal = 0.0; // Total should be 0 since no columns to sum

	        // When
	        double result = DataUtilities.calculateRowTotal(emptyData, row);
	    ...
	    public void testCalculateRowTotal_EmptyValidCols() {
	        // Given
	        final Values2D data = new DefaultKeyedValues2D(); // Empty data
	        final int row = 0;
	        final double expectedTotal = 0.0; // Total should be 0 since no valid columns

	        // When
	        double result = DataUtilities.calculateRowTotal(data, row, new int[]{});
	    ...
	    @Test
	    public void testCalculateRowTotal_ValidColsWithNullData() {
	        // Given
	        final Values2D data = new DefaultKeyedValues2D(); // Empty data
	        final int row = 0;
	        final double expectedTotal = 0.0; // Total should be 0 since data is empty

	        // When
	        double result = DataUtilities.calculateRowTotal(data, row, new int[]{0, 1, 2});
	    ...
	    @Test
	    public void testCalculateColumnTotal_NonEmptyData() {
	        // Given
	        final int column = 0;
