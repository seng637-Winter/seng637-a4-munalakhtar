...
//    }
    ...
    @Test
    public void testExpand_zeroMarginss() {
...
//
    ...
    public void testExpand_zeroMargins() {
        // Test case for expanding range with zero margins
        Range range = new Range(5, 10);
        Range expandedRange = Range.expand(range, 0, 0);
    ...
    public void testExpand_positiveMargins() {
        // Test case for expanding range with positive margins
        Range range = new Range(5, 10);
        Range expandedRange = Range.expand(range, 0.1, 0.2);
    ...
    @Test
    public void testRangeCompletelyContainsAnotherRange() {
    ...
    @Test
    public void testRangePartiallyOverlaps() {
        Range range1 = new Range(1, 5);
    ...
    @Test
    public void testRangeWithNegativeBounds() {
    ...
    @Test
    public void testRangeWithDecimalBounds() {
        Range range1 = new Range(1.5, 5.5);
    ...
    @Test
    public void testCombineIgnoringNaN_Mutation2() {
        // Mutation: Change if (range1.isNaNRange()) to if (range1.isNaNRange() && range2 != null)
        Range range1 = new Range(Double.NaN, 5);
        Range range2 = new Range(1, 10);
        assertNotNull(Range.combineIgnoringNaN(range1, range2));
    }

    @Test
    public void testCombineIgnoringNaN_Mutation3() {
        // Mutation: Change if (range1.isNaNRange()) to if (!range1.isNaNRange())
        Range range1 = new Range(1, 5);
        Range range2 = null;
        assertNotNull(Range.combineIgnoringNaN(range1, range2));
    }
    ...
    @Test
    public void testCombineIgnoringNaN_Mutation4() {
        // Mutation: Change if (range1.isNaNRange()) to if (range1.isNaNRange() == false)
        Range range1 = new Range(1, 5);
    ...
    @Test
    public void testCombineIgnoringNaN_Mutation7() {
        // Mutation: Change if (range1.isNaNRange()) to if (!range1.isNaNRange() && range2 == null)
        Range range1 = new Range(1, 5);
        Range range2 = null;
        assertNotNull(Range.combineIgnoringNaN(range1, range2));
    ...
    @Test
    public void testCombineIgnoringNaN_Mutation9() {
        // Mutation: Change if (range1.isNaNRange()) to if (!range1.isNaNRange() == false)
        Range range1 = new Range(1, 5);
        Range range2 = new Range(Double.NaN, 10);
        assertNotNull(Range.combineIgnoringNaN(range1, range2));
    ...
    @Test
    public void testShiftWithNoZeroCrossing_NegativeValue_LowerDelta() {
        // Test when value is negative and delta makes it more negative
        double value = -5.0;
        double delta = -2.0;
        double result = Range.shiftWithNoZeroCrossing(value, delta);
        assertEquals(value + delta, result, 0.0001);
    }



    @Test
    public void testShiftWithNoZeroCrossing_ZeroValue() {
    ...
    @Test
    public void testShiftWithNoZeroCrossing_NegativeValue_ReplaceMethodCall() {
        // Mutation: Replace Math.min() with Math.max()
        double value = -5.0;
        double delta = 2.0;
        double result = Range.shiftWithNoZeroCrossing(value, delta);
        assertEquals(value + delta, result, 0.0001);
    ...
    @Test
    public void testShiftWithNoZeroCrossing_NegativeValue_ReplaceValueWithAnother() {
        // Mutation: Replace 0.0 with another value
        double value = -5.0;
        double delta = 2.0;
        double result = Range.shiftWithNoZeroCrossing(value, delta);
        assertEquals(value + delta, result, 0.0001);
    ...
    public void testIsNaNRange_BothNaN() {
        // Test when both lower and upper bounds are NaN
        Range range = new Range(Double.NaN, Double.NaN);
        assertTrue(range.isNaNRange());
    }

    @Test
    public void testIsNaNRange_LowerNotNaN() {
        // Test when lower bound is not NaN
        Range range = new Range(1.0, Double.NaN);
        assertFalse(range.isNaNRange());
    }

    @Test
    public void testIsNaNRange_UpperNotNaN() {
        // Test when upper bound is not NaN
    ...
    public void testIsNaNRange_NeitherNaN() {
        // Test when neither lower nor upper bound is NaN
        Range range = new Range(1.0, 2.0);
        assertFalse(range.isNaNRange());
    }
    @Test
    public void testIsNaNRange_NaNAndInfinity() {
        // Test when one bound is NaN and the other is positive infinity
        Range range = new Range(Double.NaN, Double.POSITIVE_INFINITY);
        assertFalse(range.isNaNRange());
    }

    @Test
    public void testIsNaNRange_NaNAndNegativeInfinity() {
        // Test when one bound is NaN and the other is negative infinity
        Range range = new Range(Double.NaN, Double.NEGATIVE_INFINITY);
        assertFalse(range.isNaNRange());
    }

    @Test
    public void testIsNaNRange_PositiveInfinity() {
        // Test when both bounds are positive infinity
    ...
    public void testIsNaNRange_NegativeInfinity() {
        // Test when both bounds are negative infinity
    ...
    public void testHashCode_Simple() {
        // Test a simple range with integer bounds
        Range range = new Range(0, 10);
        int expectedHash = 29 * (int) (Double.doubleToLongBits(0) ^ (Double.doubleToLongBits(0) >>> 32))
                         + (int) (Double.doubleToLongBits(10) ^ (Double.doubleToLongBits(10) >>> 32));
        assertEquals(expectedHash, range.hashCode());
    }

    @Test
    public void testHashCode_NegativeValues() {
        // Test a range with negative bounds
        Range range = new Range(-5, -1);
        int expectedHash = 29 * (int) (Double.doubleToLongBits(-5) ^ (Double.doubleToLongBits(-5) >>> 32))
                         + (int) (Double.doubleToLongBits(-1) ^ (Double.doubleToLongBits(-1) >>> 32));
        assertEquals(expectedHash, range.hashCode());
    }


    @Test
    public void testHashCode_EqualBounds() {
        // Test a range with equal bounds
        Range range = new Range(5, 5);
        int expectedHash = 29 * (int) (Double.doubleToLongBits(5) ^ (Double.doubleToLongBits(5) >>> 32))
                         + (int) (Double.doubleToLongBits(5) ^ (Double.doubleToLongBits(5) >>> 32));
        assertEquals(expectedHash, range.hashCode());
    }
    @Test
    public void testHashCode_ZeroBounds() {
        // Test a range with both bounds set to zero
        Range range = new Range(0, 0);
        int expectedHash = 29 * (int) (Double.doubleToLongBits(0) ^ (Double.doubleToLongBits(0) >>> 32))
                         + (int) (Double.doubleToLongBits(0) ^ (Double.doubleToLongBits(0) >>> 32));
        assertEquals(expectedHash, range.hashCode());
    }

    @Test
    public void testHashCode_NaNValues1() {
        // Test a range with NaN bounds
        Range range = new Range(Double.NaN, Double.NaN);
        int expectedHash = 29 * (int) (Double.doubleToLongBits(Double.NaN) ^ (Double.doubleToLongBits(Double.NaN) >>> 32))
                         + (int) (Double.doubleToLongBits(Double.NaN) ^ (Double.doubleToLongBits(Double.NaN) >>> 32));
        assertEquals(expectedHash, range.hashCode());
    }

    @Test
    public void testHashCode_LowerBoundNaN() {
        // Test a range with lower bound set to NaN
    ...
    @Test
    public void testHashCode_UpperBoundNaN() {
        // Test a range with upper bound set to NaN
    ...
    public void testHashCode_PositiveBounds() {
        // Test a range with positive bounds
        Range range = new Range(2.5, 7.5);
        int expectedHash = 29 * (int) (Double.doubleToLongBits(2.5) ^ (Double.doubleToLongBits(2.5) >>> 32))
                         + (int) (Double.doubleToLongBits(7.5) ^ (Double.doubleToLongBits(7.5) >>> 32));
        assertEquals(expectedHash, range.hashCode());
    }
    ...
    public void testHashCode_NegativeBounds() {
        // Test a range with negative bounds
        Range range = new Range(-7.5, -2.5);
        int expectedHash = 29 * (int) (Double.doubleToLongBits(-7.5) ^ (Double.doubleToLongBits(-7.5) >>> 32))
                         + (int) (Double.doubleToLongBits(-2.5) ^ (Double.doubleToLongBits(-2.5) >>> 32));
        assertEquals(expectedHash, range.hashCode());
    }

    @Test
    public void testHashCode_UpperBoundZero() {
        // Test a range with upper bound set to zero
        Range range = new Range(-2.5, 0);
        int expectedHash = 29 * (int) (Double.doubleToLongBits(-2.5) ^ (Double.doubleToLongBits(-2.5) >>> 32))
                         + (int) (Double.doubleToLongBits(0) ^ (Double.doubleToLongBits(0) >>> 32));
        assertEquals(expectedHash, range.hashCode());
    }
    ...
    @Test
    public void testHashCode_LowerBoundZero() {
        // Test a range with lower bound set to zero
        Range range = new Range(0, 2.5);
        int expectedHash = 29 * (int) (Double.doubleToLongBits(0) ^ (Double.doubleToLongBits(0) >>> 32))
                         + (int) (Double.doubleToLongBits(2.5) ^ (Double.doubleToLongBits(2.5) >>> 32));
        assertEquals(expectedHash, range.hashCode());
    }
    ...
    @Test
    public void testExpand_Mutation_LowerBoundShifted() {
        // Test mutation where lower bound is shifted by adding length * lowerMargin
        Range range = new Range(0, 10);
    ...
    @Test
    public void testExpand_Mutation_LowerAndUpperBoundShifted() {
        // Test mutation where both lower and upper bounds are shifted
        Range range = new Range(0, 10);
        Range expandedRange = Range.expand(range, -0.1, -0.1);
        assertEquals(1.0, expandedRange.getLowerBound(), 0.0001);
        assertEquals(9.0, expandedRange.getUpperBound(), 0.0001);
    }
}